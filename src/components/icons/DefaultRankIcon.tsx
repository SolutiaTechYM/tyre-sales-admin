...
export const DefaultRankIcon = (props: SVGProps<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      <path
        fill="#B0B0B0" // Default grey color
      ...
      />
      <path
        fill="#8C8C8C" // Darker grey for contrast
        fillRule="evenodd"
      ...
      />
      <path
        fill="#E0E0E0" // Light grey for the internal details
